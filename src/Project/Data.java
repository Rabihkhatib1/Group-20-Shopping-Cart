    ...
    public void dataUpdatefromFile(){
        ...
        for(int i = 0; i < pItems.size(); i++ ) {
            ...
            if ("Bundle".equals(pNames.get(i))) {
                ...
                this.costs += (bundle.getPrice()/2) * bundle.getStock();
                ...
                this.costs += (product.getPrice()/2) * bundle.getStock();
